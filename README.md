...
| File | Description |
|------|-------------|
| [`alu.v`](alu.v) | RTL design source of the 8-Bit Parametric ALU |
| [`tb.v`](tb.v) | Testbench module with opcode test loop |
| `ALU.xpr` | Xilinx Vivado Project File |
